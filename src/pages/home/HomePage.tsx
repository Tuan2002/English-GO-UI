    ...
    <>
      <div className={cx("banner")}>
        ...
        <a href="#" className={cx('button', 'button-primary')}>
          Vào thi ngay <FontAwesomeIcon icon={faHeadphones} />
        </a>
        
        <a href="#" className={cx('button', 'button-secondary')}>
          Lịch thi mới nhất <FontAwesomeIcon icon={faCalendarDays} />
        </a>
      </div>
          </div>
        </div>
      ...
      <div className={cx("container")}>
        ...
        <div className={cx("services")}>
          <div className={cx("service-box")}>
            ...
            <ul>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Làm quen với giao diện,
                các chức năng của phần mềm thi trên máy tính.
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Nắm rõ được định dạng
                đề thi, các bước làm bài thi.
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Ôn luyện không giới hạn
                với kho đề thi khổng lồ được cập nhật mới thường xuyên.
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Tương thích với mọi
                thiết bị: máy tính, điện thoại... Bạn có thể ôn luyện ở bất cứ
                đâu.
              </li>
            </ul>
          </div>
          <div className={cx("service-box")}>
            ...
            <ul>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Luyện thi từng kỹ năng,
                lời giải chi tiết, script bài nghe, mẫu bài viết, bài nói...
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Ôn luyện không giới hạn
                với kho đề thi khổng lồ được cập nhật mới thường xuyên.
          ...
          <div className={cx("service-box")}>
            ...
            <ul>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Có ngay kết quả bài thi
                trắc nghiệm, tự đánh giá được năng lực hiện tại.
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Đăng ký chấm thi tự
                luận với giảng viên có nhiều năm kinh nghiệm.
              </li>
            </ul>
          </div>
          <div className={cx("service-box")}>
            ...
            <ul>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Cung cấp toàn bộ thông
                tin liên quan về kỳ thi VSTEP.
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Cập nhật lịch thi VSTEP
                tại các đơn vị mới nhất, đầy đủ nhất.
              </li>
              <li>
                <FontAwesomeIcon icon={faCircleCheck} /> Tuyển sinh đầu vào, đầu
                ra cho các Trung tâm.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className={cx("content")}>
          <div className={cx("text")}>
            ...
            <p className={cx("description")}>
              ...
              thí sinh trước mỗi kỳ thi. Đăng ký thi để dễ dàng với quy trình
              thi như sau:
            </p>
            <ul className={cx("steps")}>
              ...
              <li>
                Hệ thống tự động cấp tài khoản thi trực tuyến ngay sau khi đăng
                ký, đồng thời gửi thông tin qua email
              </li>
              <li>
                Đăng nhập hệ thống, chụp hình, kiểm tra microphone và tai nghe
              </li>
              <li>
                Nhận đề, vào thi 04 kỹ năng theo đúng thứ tự: Nghe (47 phút) -
                Đọc (60 phút) - Viết (60 phút) - Nói (12 phút)
              </li>
              <li>Bấm Nộp bài khi kết thúc cả 04 kỹ năng</li>
              <li>
                Nhận ngay điểm thi và kết quả chi tiết phần thi trắc nghiệm, có
                thể đăng ký chấm thi tự luận
              </li>
            </ul>
          </div>
